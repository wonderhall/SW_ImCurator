(function () {
    ...
    //UNITY STUFF
    var buildUrl = "Build";
    var loaderUrl = buildUrl + "/SW_ImCurator.loader.js";
    var config = {
        dataUrl: buildUrl + "/SW_ImCurator.data",
        frameworkUrl: buildUrl + "/SW_ImCurator.framework.js",
        codeUrl: buildUrl + "/SW_ImCurator.wasm",
        streamingAssetsUrl: "StreamingAssets",
        companyName: "DefaultCompany",
        productName: "SwimCurator",
        productVersion: "0.1",
    };
